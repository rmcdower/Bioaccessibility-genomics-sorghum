...
#Notes
Code for permutation test is meant to run one year file at a time, read commented lines to make sure phenotype columns correspond to the correct year data file
